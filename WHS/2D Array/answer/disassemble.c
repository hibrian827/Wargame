...
int sub_133F(int a1)
{
  ...
  for ( i = 0; i <= 3; ++i )
  {
    ...
    {
      v2 = *(_BYTE *)(a1 + 8 * i + j);
      *(_BYTE *)(a1 + 8 * i + j) = *(_BYTE *)(a1 + 8 * (8 - i) - 8 + j);
      result = j;
      *(_BYTE *)(8 * (8 - i) - 8 + a1 + j) = v2;
    }
  }
  return result;
}
...
int sub_158A(int a1, int a2, unsigned int a3)
{
  ...
  for ( i = 0; i <= 7; ++i )
  {
    ...
    {
      result = j;
      *(_BYTE *)(a1 + 8 * i + j) ^= *(_BYTE *)((j + i) % a3 + a2);
    }
  }
  return result;
}
...
int sub_1407(int a1)
{
  ...
  for ( i = 0; i <= 7; ++i )
  {
    ...
    {
      v2 = *(_BYTE *)(a1 + 8 * i + j);
      *(_BYTE *)(8 * i + a1 + j) = *(_BYTE *)(a1 + 8 * i + 7 - j);
      result = 7 - j;
      *(_BYTE *)(8 * i + a1 + result) = v2;
    }
  }
  return result;
}
...
int main()
{
  ...
  sub_133F(s);
  sub_158A(s, &unk_2037, 8);
  sub_1407(s);
  sub_1622(s, &unk_2040, 8);
  sub_14D0(s);
  if ( !memcmp(s, &unk_2050, 0x40) )
  {
